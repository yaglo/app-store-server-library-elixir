defmodule AppStoreServerLibrary.Models.LifetimeDollarsRefunded do
  @moduledoc """
  A value that indicates dollar amount of refunds the customer has received in your app, since purchasing the app, across all platforms.
  ...
  @doc """
  Convert integer to lifetime dollars refunded atom
  """
  ...
  @doc """
  Convert lifetime dollars refunded atom to integer
  """
